var app = {
	...
	*/
	...
	/** 
	 * @brief Description : init variblable that should be declared only in app
   ...
   */
	 ...
	 * @var rgxfinal    : containe the the varible and his value   		
   ...
   */
    ...
    */
	scope : function(start,method){//start: 
